...
namespace MySynch.Tests
{
    ...
    //        var actualData = remoteSourceOfData.GetData(new GetDataRequest { FileName = @"Data\Test\F1\F11\F12\F12.xml" });
    ...
    //    {
    //        RemoteSourceOfData remoteSourceOfData = new RemoteSourceOfData();
    //        remoteSourceOfData.GetData(new GetDataRequest { FileName = @"Data\Test\F11\F11\F12\F12.xml" });
    //    }
    //}
}
