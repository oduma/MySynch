...
namespace MySynch.Tests
{
    ...
    new MySynchLocalComponentConfigurationSection { BrokerUrl = "", LocalRootFolder = @"Data\Output\Test\" };
        ...
        public void ReceiveMessage_Ok()
        {
            ...
            MySynchLocalComponentConfigurationSection localComponentConfig =
    new MySynchLocalComponentConfigurationSection { BrokerUrl = "", LocalRootFolder = @"Data\Output\Test\" };
            string hostUrl = "my subscriber url";
            subscriber.Initialize(mySynchComponentResolver.Resolve<IBrokerProxy>("IBroker.Remote"), localComponentConfig, hostUrl);
