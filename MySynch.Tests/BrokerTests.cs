...
namespace MySynch.Tests
{
    ...
    public class BrokerTests
    {
        ...
        {
            MySynchBrokerConfigurationSection storeType = new MySynchBrokerConfigurationSection { StoreName = "store1.xml", StoreType = "IStore.Registration.DeffectiveStore" };
            ComponentResolver componentResolver = new ComponentResolver();
            componentResolver.RegisterAll(new AllStoresInstaller());
            Broker broker = new Broker(storeType, componentResolver);
            AttachRequest request = new AttachRequest
        ...
        {
            MySynchBrokerConfigurationSection storeType = new MySynchBrokerConfigurationSection { StoreName = @"Data\storetest.xml", StoreType = "IStore.Registration.FileSystemStore" };
            ComponentResolver componentResolver = new ComponentResolver();
            componentResolver.RegisterAll(new AllStoresInstaller());
            Broker broker = new Broker(storeType, componentResolver);
        ...
        {
            MySynchBrokerConfigurationSection storeType = new MySynchBrokerConfigurationSection { StoreName = @"Data\storetest.xml", StoreType = "IStore.Registration.DeffectiveStore" };
        ...
        {
            MySynchBrokerConfigurationSection storeType = new MySynchBrokerConfigurationSection { StoreName = @"Data\storetestget.xml", StoreType = "IStore.Registration.FileSystemStore" };
            ComponentResolver componentResolver = new ComponentResolver();
            componentResolver.RegisterAll(new AllStoresInstaller());
            Broker broker = new Broker(storeType, componentResolver);
        ...
        {
            MySynchBrokerConfigurationSection storeType = new MySynchBrokerConfigurationSection { StoreName = @"Data\storetestget.xml", StoreType = "IStore.Registration.DeffectiveGetStore" };
        ...
        {
            MySynchBrokerConfigurationSection storeType = new MySynchBrokerConfigurationSection { StoreName = @"Data\wrongfile.xml", StoreType = "IStore.Registration.FileSystemStore" };
            ComponentResolver componentResolver = new ComponentResolver();
            componentResolver.RegisterAll(new AllStoresInstaller());
            Broker broker = new Broker(storeType, componentResolver);
            var response = broker.ListAllRegistrations();
        ...
        {
            MySynchBrokerConfigurationSection storeType = new MySynchBrokerConfigurationSection { StoreName = @"Data\storetestwsub.xml", StoreType = "IStore.Registration.FileSystemStore" };
        ...
        public void Broker_ComponentNotRegistered()
        {
            ...
            ComponentResolver.RegisterAll(new TestInstaller());
            Broker broker =
                new Broker(new MySynchBrokerConfigurationSection() {StoreName = "store.xml", StoreType = "IStore.Registration.Wrong"},
                           ComponentResolver);
        }
