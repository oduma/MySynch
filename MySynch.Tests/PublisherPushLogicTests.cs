...
namespace MySynch.Tests
{
    ...
    public class PublisherPushLogicTests
    {
        ...
        {
            PushPublisher pushPublisher = new PushPublisher();
            pushPublisher.Initialize(new BrokerClient(),new LocalComponentConfig(),null);
        }
        [Test]
        [ExpectedException(typeof(ArgumentNullException))]
        ...
        {
            PushPublisher pushPublisher = new PushPublisher();
            pushPublisher.Initialize(new BrokerClient(), new LocalComponentConfig{RootFolder="my root folder"}, string.Empty);
        }
        ...
        {
            PushPublisher pushPublisher = new PushPublisher();
            pushPublisher.Initialize(new BrokerClient(), new LocalComponentConfig { RootFolder = @"c:\" }, "my host url");
