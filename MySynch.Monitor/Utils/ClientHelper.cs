...
namespace MySynch.Monitor.Utils
{
    public class ClientHelper
    {
        ...
        public IBrokerMonitorProxy ConnectToADuplexBroker(EventHandler<ProgressChangedEventArgs> progressChanged, string brokerMonitorUrl, InstanceContext callbackInstance)
        {
            progressChanged(this, new ProgressChangedEventArgs(0, "Connecting to Broker monitor: " + brokerMonitorUrl));
            ...
            progressChanged(this, new ProgressChangedEventArgs(0, "Connected to Broker monitor: " + brokerMonitorUrl));
            return brokerClient;
        }
    }
}
