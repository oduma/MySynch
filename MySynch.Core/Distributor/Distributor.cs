...
namespace MySynch.Core.Distributor
{
    ...
    //                {
    //                    var response = channel.Subscriber.ReceiveMessage(new ReceiveMessageRequest
    //                    {
    ...
    //    private void RegisterMessageInPackage(ReceiveMessageResponse message, Guid packageId)
    //    {
