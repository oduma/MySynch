...
xcopy ..\MySynch.Monitor\Assemblies\*.exe ..\MySynch.Monitor\Exe\*.* /Y
del ..\MySynch.Monitor\Assemblies\*.exe
...
heat dir ..\MySynch.Monitor\Assemblies -srd -dr MONITOR -cg MonitorGroup -var var.MonitorSource -gg -out MonitorGroup.wxs
